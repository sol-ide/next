...
# Toolset detection.
if (NOT NEXT_TOOLSET)
  set(NEXT_TOOLSET "unknown")
  if (MSVC60)
    set(NEXT_TOOLSET "vc6")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "6.0")
  elseif(MSVC70)
    set(NEXT_TOOLSET "vc7")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "7.0")
  elseif(MSVC71)
    set(NEXT_TOOLSET "vc71")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "7.1")
  elseif(MSVC80)
    set(NEXT_TOOLSET "vc80")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "8.0")
  elseif(MSVC90)
    set(NEXT_TOOLSET "vc90")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "9.0")
  elseif(MSVC100)
    set(NEXT_TOOLSET "vc100")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "10.0")
  elseif(MSVC110)
    set(NEXT_TOOLSET "vc110")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "11.0")
  elseif(MSVC120)
    set(NEXT_TOOLSET "vc120")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "12.0")
  elseif(MSVC130)
    set(NEXT_TOOLSET "vc130")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "13.0")
  elseif(MSVC)
    set(NEXT_TOOLSET "vc")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "unknown")
  elseif(BORLAND)
    set(NEXT_TOOLSET "bcb")
    set(NEXT_COMPILER "msvc")
    set(NEXT_COMPILER_VERSION "unknown")
  elseif(CMAKE_COMPILER_IS_GNUCC OR CMAKE_COMPILER_IS_GNUCXX)
    set(NEXT_COMPILER "gcc")
...
elseif(UNIX)
  ...
  if (MINGW)
    set(NEXT_PLATFORM "mingw")
  elseif(CYGWIN)
    set(NEXT_PLATFORM "cygwin")
  elseif (CMAKE_SYSTEM_NAME STREQUAL "Linux")
    set(NEXT_PLATFORM "linux")
  else()
    set(NEXT_PLATFORM "unix")
  endif()
elseif(WIN32)
  set(NEXT_PLATFORM "windows")
else()
  set(NEXT_PLATFORM "unknown")
endif()

# create cache entry
set(NEXT_PLATFORM ${NEXT_PLATFORM} CACHE STRING "Next platform name")

next_report_pretty("Next platform" NEXT_PLATFORM)
...
# configurations.
set(CMAKE_CXX_FLAGS_DEBUG "" CACHE INTERNAL "Unused by Next")
set(CMAKE_SHARED_LINKER_FLAGS_DEBUG "" CACHE INTERNAL "Unused by Next")
set(CMAKE_MODULE_LINKER_FLAGS_DEBUG "" CACHE INTERNAL "Unused by Next")
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "" CACHE INTERNAL "Unused by Next")
set(CMAKE_CXX_FLAGS_RELEASE "" CACHE INTERNAL "Unused by Next")
set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "" CACHE INTERNAL "Unused by Next")
set(CMAKE_MODULE_LINKER_FLAGS_RELEASE "" CACHE INTERNAL "Unused by Next")
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "" CACHE INTERNAL "Unused by Next")
set(CMAKE_CXX_FLAGS_MINSIZEREL "" CACHE INTERNAL "Unused by Next")
set(CMAKE_SHARED_LINKER_FLAGS_MINSIZEREL "" CACHE INTERNAL "Unused by Next")
set(CMAKE_MODULE_LINKER_FLAGS_MINSIZEREL "" CACHE INTERNAL "Unused by Next")
set(CMAKE_EXE_LINKER_FLAGS_MINSIZEREL "" CACHE INTERNAL "Unused by Next")
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "" CACHE INTERNAL "Unused by Next")
set(CMAKE_SHARED_LINKER_FLAGS_RELWITHDEBINFO "" CACHE INTERNAL "Unused by Next")
set(CMAKE_MODULE_LINKER_FLAGS_RELWITHDEBINFO "" CACHE INTERNAL "Unused by Next")
set(CMAKE_EXE_LINKER_FLAGS_RELWITHDEBINFO "" CACHE INTERNAL "Unused by Next")

# Set the build name 
set(BUILDNAME "${NEXT_COMPILER}-${NEXT_COMPILER_VERSION}-${NEXT_PLATFORM}")
next_report_pretty("Build name" BUILDNAME)
...
if(LIB_SUFFIX)
  next_report_pretty("Lib suffix" LIB_SUFFIX)
endif()
...
if(NEXT_CMAKE_SELFTEST)
  ...
  set(NEXT_CMAKE_SELFTEST_ROOT ${root})
else()
  set(root "${CMAKE_CURRENT_SOURCE_DIR}")
endif()

set(NEXT_LIBS_PARENT_DIR "${root}/libs" CACHE INTERNAL
  "Directory to glob tools from...  only change to test the build system itself")

set(NEXT_TOOLS_PARENT_DIR "${root}/tools" CACHE INTERNAL
  "Directory to glob tools from...  only change to test the build system itself")
